...
ggplot(emo, aes(x = Val)) +
  ...
  geom_vline(aes(xintercept = M), linetype = 3, colour = "green") +
  geom_vline(aes(xintercept = X1), linetype = 2, colour = "black") +
  geom_vline(aes(xintercept = X2), linetype = 2, colour = "red") +
  theme_minimal()
